 ...
 * NOTE: super.cleanup() must be called at the bottom of overridden cleanup() methods, and cleanup() must be called at the bottom of the run() method for all extended classes. <br><br><b><i>
...
public class SimpleThread extends Thread {
	...
	/**
	 * Removes all references to instantiated objects, and changes the thread's state to "not alive". Method alive() returns false when this method has completed. NOTE: super.cleanup() must be
	 * called at the bottom of overridden cleanup() methods, and cleanup() must be called at the bottom of the run() method for all extended classes.
	 */
	...
	/**
	 * Calls the rerun() method on a separate thread, which calls run() when the previous thread finishes.
	 */
	public void restart() {
		new Thread() {
			@Override
