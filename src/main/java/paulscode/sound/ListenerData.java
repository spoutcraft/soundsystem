...
/**
 * The listenerData class is used to store information about the listener's position and orientation. A ListenerData object can be obtained using SoundSystem's getListenerData() method. See {@link
 * paulscode.sound.Vector3D Vector3D} for more information about 3D coordinates and vectors. <br><br><b><i>SoundSystem License:</b></i> <br><b><br> You are free to use this library for any
 * purpose, commercial or otherwise. You may modify this library or source code, and distribute it any way you like, provided the following conditions are met: <br>1) You may not falsely claim to be
 * the author of this library or any unmodified portion of it. <br>2) You may not copyright this library or a modified version of it and then sue me for copyright infringement. <br>3) If you modify
 * the source code, you must clearly document the changes made before redistributing the modified source code, so other users know it is not the original code. <br>4) You are not required to give me
...
public class ListenerData {
	 ...
	 * @param a Angle in radians that the listener is turned counter-clockwise around the y-axis.
	 */
	...
	/**
	 * Sets the listener's angle counter-clockwise around the y-axis.
	 *
