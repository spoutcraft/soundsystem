...
/**
 * The Vector3D class contains methods to simplify common 3D vector functions, such as cross and dot product, normalize, etc. <br><br> <b><i>    SoundSystem License:</b></i><br><b><br> You are free to
 * use this library for any purpose, commercial or otherwise. You may modify this library or source code, and distribute it any way you like, provided the following conditions are met: <br> 1) You may
 * not falsely claim to be the author of this library or any unmodified portion of it. <br> 2) You may not copyright this library or a modified version of it and then sue me for copyright
 * infringement. <br> 3) If you modify the source code, you must clearly document the changes made before redistributing the modified source code, so other users know it is not the original code. <br>
 * 4) You are not required to give me credit for this library in any derived work, but if you do, you must also mention my website: http://www.paulscode.com <br> 5) I the author will not be
